...
//create empty placeholders. created for all nine spots. unnecessary items get removed later.			
			for(var i = 0; i < 10; i += 1)	{
				myControl.ext.myownersbox_configurator.util.selectedULTemplate(i,{});
				}
...
//also executed as part of addToSelectedUL()
			selectedULTemplate : function(spot,P)	{
				...
				if(!P.pid)
					o += " disabled='disabled' "
				o += ">X<\/button><\/div><div onClick=\"myControl.ext.myownersbox_configurator.util.drawerClicked('"+P.pid+"','selectedDrawerLoc_"+spot+"')\">";
