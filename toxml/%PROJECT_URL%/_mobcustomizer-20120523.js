...
$('#organizerPreviewForPrint').empty().html(myControl.util.makeImage({"h":"500","w":"500","b":"ffffff","name":myControl.data['appProductGet|'+pid]['%attribs']['zoovy:prod_image1'],"tag":1}));
