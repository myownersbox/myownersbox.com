...
//if this is a custom extension and you are loading system extensions (prodlist, etc), then load ALL templates you'll need here.
		...
		"dependencies" : ['store_prodlist','store_navcats','store_product','store_search','store_cart','store_crm','myownersbox_configurator'] //a list of other extensions (just the namespace) that are required for this one to load
		},
