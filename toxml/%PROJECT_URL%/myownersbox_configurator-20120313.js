...
//for a list of keys/values, see
			onSuccess : function(P)	{
				this.addPushState({'catSafeID':'.customizer'});
...
//once recentlyViewed is populated, it gets displayed and rerendered with each change, so that the carousel updates.
					myControl.ext.store_prodlist.util.buildProductList({"templateID":"mobRecentViewedProductSpec","parentID":"recentlyRemovedProdlist","csv":myControl.ext.myownersbox_configurator.vars.recentlyRemoved})
...
//<input type="text" style="text-align:center;" size="2" value="0" name="qty:MODEL08" class="zform_textbox">
